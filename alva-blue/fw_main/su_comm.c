...
const struct gpio_init_table_t su_comm_gpio[] = {
	{ // TIM2 CH4
		.gpio = GPIOA,
		.pin = GPIO_Pin_3,
...
{
	gpio_init(su_comm_gpio, ARRAY_SIZE(su_comm_gpio));
	...
	// 18MHz PWM signal generator
	uint32_t f = SystemFrequency / 18000000;
	// timebase init
